...
hs.hotkey.bind(MEH, "p", function()
  shellTask("/opt/homebrew/bin/yabai -m window --toggle border; /opt/homebrew/bin/yabai -m window --toggle pip; /opt/homebrew/bin/yabai -m window --toggle float; /opt/homebrew/bin/yabai -m window --grid 8:8:6:5:2:3")
end)
...
hs.hotkey.bind(MEH, "j", function()
  shellTask("/opt/homebrew/bin/yabai -m window --focus south || /opt/homebrew/bin/yabai -m window --focus stack.next || /opt/homebrew/bin/yabai -m window --focus stack.first")
end)

hs.hotkey.bind(MEH, "k", function()
  shellTask("/opt/homebrew/bin/yabai -m window --focus north || /opt/homebrew/bin/yabai -m window --focus stack.prev || /opt/homebrew/bin/yabai -m window --focus stack.last")
end)
...
hs.hotkey.bind(ADJUST, "h", function()
  shellTask("/opt/homebrew/bin/yabai -m window --resize left:-80:0 || /opt/homebrew/bin/yabai -m window --resize right:-80:0")
end)

hs.hotkey.bind(ADJUST, "j", function()
  shellTask("/opt/homebrew/bin/yabai -m window --resize bottom:0:80 || /opt/homebrew/bin/yabai -m window --resize top:0:80")
end)

hs.hotkey.bind(ADJUST, "k", function()
  shellTask("/opt/homebrew/bin/yabai -m window --resize top:0:-80 || /opt/homebrew/bin/yabai -m window --resize bottom:0:-80")
end)

hs.hotkey.bind(ADJUST, "l", function()
  shellTask("/opt/homebrew/bin/yabai -m window --resize right:80:0 || /opt/homebrew/bin/yabai -m window --resize left:80:0")
end)

-- Toggle window zoom
hs.hotkey.bind(HYPEEEER, "f", function() shellTask("/opt/homebrew/bin/yabai -m window --toggle zoom-fullscreen") end)
hs.hotkey.bind(HYPEEEER, "d", function() shellTask("/opt/homebrew/bin/yabai -m window --toggle zoom-parent") end)
...
hs.hotkey.bind(HYPEEEER, "c", function() toggleAppWindow("Calendar") end)
hs.hotkey.bind(HYPEEEER, "m", function() toggleAppWindow("com.spotify.client") end)
hs.hotkey.bind(HYPEEEER, "n", function() toggleAppWindow("Obsidian") end)
hs.hotkey.bind(HYPEEEER, "b", function() shellTask("/Applications/Google\\ Chrome.app/Contents/MacOS/Google\\ Chrome --new-window") end)
